...
export default function page() {
  return (
    <div>
      <title>Scarica Facebook Reels online gratuitamente</title>
      <meta
        name="description"
        content="Scarica facilmente Facebook Reels in alta qualità con il nostro strumento semplice, veloce e gratuito. Salva i tuoi video preferiti per guardarli offline e condividerli ovunque e in qualsiasi momento!"
      />
      ...
      <DynamicBox
        title="Vuoi scaricare video di Facebook?"
        text="Cliccando su questo pulsante puoi accedere alla pagina di download video di Facebook 
  e scaricare qualsiasi video di Facebook in alta qualità."
        buttonName="Downloader di Facebook"
        link="https://FBDownloaderr.net/it"
      />
