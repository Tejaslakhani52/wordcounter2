  ...
  return (
    <div className="w-[75%] mx-auto max-md:w-[95%]">
      ...
      <p className="mb-3">
        ...
        our website and services, including, without limitation, the following:
      </p>
      <p className="mb-3">
        FBDownloaderr.net, the fbdownloader application, and the fbdownloader
        browser extension
      </p>
      <p className="mb-3">
        This document states the terms and conditions (“Terms”) upon which
        FBDownloaderr.net (“we” or “us”) will provide service to you on its
        website, applications and related services (collectively, the
        “Service”). As used in this document, the terms “you” or “your” refers
        to you, any entity you represent, your or its representatives,
      ...
      <p className="mb-3">
        <b>
          ...
          understanding and acceptance of these Terms. If you do not agree to be
          bound by these Terms, cease using the Service and delete any copy of
          the Service which you may have.
        </b>
      </p>
      <p className="mb-5">
        <b>
          These terms also include certain liability limitations and legal
          disclaimers that limit our liabilities. In other words, your use of
          the Service is at your own risk and we do not assume any liability, or
          make any warranties of any kind, express or implied, with respect to
          the Service.
        </b>
      </p>
      ...
      <p className="mb-3">
        a. Use of the Service is not permitted where prohibited by law. Without
        limiting the foregoing, you represent and warrant that you are not
        located in a country that is subject to international or applicable
        embargo, or a country that has been designated by the international or
        applicable law as a “terrorist supporting” country and that you are not
        listed on any applicable list of prohibited or restricted parties.
      </p>
      <p className="mb-3">
        b. You must be at least eighteen (18) years of age to use the Service.
        If you are under eighteen (18) years old, you are not permitted to use
        the Service and you must immediately cease using the Service, regardless
        of parental authorization.
      </p>
      <p className="mb-3">
        c. You may be required, from time to time and at our discretion, to
        create an account with us (an “Account”) to use parts of the Service to
        its fullest extent. In such cases: You represent and warrant that all
        information that you provide to us in creating your Account is complete
        and accurate. You shall update such information when it changes or when
        we request. You acknowledge that we may also access, with your
        permission, personally identifiable information through a third-party or
        other means based on the permissions you provide. You shall not use
        another person or entity’s Account without authorization or access the
        accounts of any other person on any other systems. You shall be solely
        responsible for maintaining the confidentiality of and restricted access
        to your Account. You shall be solely responsible for all activities that
        occur under your Account. You shall notify us immediately of any breach
        of security or unauthorized use of your Account. Pursuant to the terms
        herein, we shall not be liable for any losses resulting from any
        unauthorized use of your Account and, in addition to the further
        indemnification herein, you hereby indemnify us and hold us harmless for
        any such unauthorized use. You acknowledge and understand that anyone
        who gains access to your Account will gain access to all of your data on
        your Account, including any private content.
      </p>
      <p className="mb-3">
        d. The consideration for your knowing acceptance of these Terms is that
        we are providing you the Grant of Use to use the Service pursuant to
        Section 2 hereof. You acknowledge and agree that this consideration is
        adequate and that you have received the same upon use of the Service.
      </p>
      <h2 className="text-[20px] mb-3 font-semibold">2. Grant of Use</h2>

      <ol style={{ listStyleType: "decimal", marginLeft: "50px" }}>
        <li>
          We grant you a non-exclusive, non-transferable, and limited right to
          access, non-publicly display, and use the Service, including all
          content available therein (the “Content”) on your computer or mobile
          device consistent with these Terms and subject to the restrictions
          (technical and otherwise) of the Service. You may only access and use
        ...
        <li className="mb-3">
          ...
          but shall not be obligated to: (i) delete or deactivate your Account
          or use of the Service, (ii) block your e-mail and/or IP addresses or
          otherwise terminate your use of and ability to use the Service, and/or
          (iii) remove and/or delete any of your User Submissions (defined
          below). You agree not to use or attempt to use the Service after said
          termination. Upon termination, the grant of your right to use the
          Service shall terminate, but all other portions of these Terms shall
        ...
        <li className="mb-3">
          ...
          shall be limited by the rules, features and technical restrictions of
          the Service, which may change from time to time in our sole
          discretion. You shall not attempt to use the Service in any manner in
          which the Service is not intended or permitted to be used.
        </li>
      </ol>
      ...
      <p className="mb-3">
        ...
        Proprietary Materials are subject to copyright, trademark, and/or other
        rights under the laws of applicable jurisdictions, including domestic
        laws, foreign laws, and international conventions. We reserve all our
      ...
      <h2 className="text-[20px] mb-3 mt-3 font-semibold">
        4. User Submissions
      </h2>
      <p className="mb-3">
        a. You are entirely responsible for any and all materials you download,
        upload, submit, transmit, create, modify or otherwise make available in
        or via the Service, including any sound files, video files, or
        photographs that you create, modify, transmit or download through the
        Service (collectively, “User Submissions”). User Submissions cannot
        always be withdrawn. You acknowledge that any disclosure of personal
        information in User Submissions may make you personally identifiable and
        that we do not guarantee any confidentiality with respect to User
        Submissions.
      </p>
      <p className="mb-3">
      ...
      <p className="mb-3">
        i. You own or have the necessary licenses, permissions, rights, or
        consents to use and authorize us to use all trademarks, copyrights,
        trade secrets or other proprietary rights in and to User Submissions for
        any and all uses contemplated by the Service and these Terms; and
      </p>
      <p className="mb-3">
        ii. You have written consent, release, and/or permission from each and
        every identifiable individual in the User Submission to use the name
        and/or likeness of each and every such identifiable individual to enable
        use of the User Submission for any and all uses contemplated by the
      ...
      <p className="mb-3">
        i. Is copyrighted, protected by trade secret or trademark laws, or
      ...
      <p className="mb-3">
        ii. Is obscene, vulgar, illegal, unlawful, defamatory, fraudulent,
      ...
      <p className="mb-3">
        iii. Depicts illegal activities, promotes or depicts physical harm or
        injury against any group or individual, or promotes or depicts any act
        of cruelty to animals;
      </p>
      <p className="mb-3">
        iv. Impersonates any person or entity or otherwise misrepresents you in
      ...
      <p className="mb-3">
        vi. Is unsolicited or unauthorized advertising, promotion, “spam” or any
      ...
      <p className="mb-3">
        {" "}
        f. You acknowledge that we may at our sole discretion refuse to publish,
      ...
      <p className="mb-3">
        a. You understand and acknowledge that, when using the Service, you will
        be exposed to content from a variety of sources including content made
        available on or through the Service by other users, services, parties
        and through automated or other means (collectively, “Third Party
        Content”) and that we do not control and are not responsible for any
        Third Party Content. You understand and acknowledge that you may be
        exposed to content that is inaccurate, offensive, indecent or otherwise
        ...
        you may have against us with respect thereto.
      </p>
      <p className="mb-3">
      ...
      <p className="mb-3">
        d. Without limiting the provisions below on limitations of liability and
        disclaimers of warranties, all Content (including User Submissions and
        Third Party Content) on the Service is provided to you “AS-IS” for your
      ...
      <p className="mb-3">
        e. You acknowledge that we may at our sole discretion refuse to publish,
        remove, or block access to any Content for any reason, or for no reason
        at all, with or without notice.
      </p>

      <h2 className="text-[20px] mb-3 font-semibold">6. User Conduct</h2>
      ...
      <p className="mb-3">c. As a condition of your use of the Service:</p>
      <p className="mb-3">
        i. You agree not to use the Service for any unlawful purpose or in any
      ...
      <p className="mb-3">
        iii. You agree not to use the Service in any way that exposes us to
        criminal or civil liability;
      </p>
      <p className="mb-3">
        iv. You agree that you are solely responsible for all acts and omissions
        that occur as a result of your use of the Service;
      </p>
      <p className="mb-3">
        v. You agree that all your User Submissions belong to you and that you
        have the right and authority to provide them to us and make use of them
        on or through the Service;
      </p>
      <p className="mb-3">
        vi. You agree not to use any automated means, including robots, crawlers
        or data mining tools, to download, monitor or use data or Content from
        the Service;
      </p>
      <p className="mb-3">
        vii. You agree not to take any action that imposes, or may impose, in
        our sole discretion, an unreasonable or disproportionately large load on
        our technology infrastructure or otherwise make excessive demands on it;
      </p>
      <p className="mb-3">
        viii. You agree not to “stalk” or otherwise harass anyone on or through
        the Service;
      </p>
      <p className="mb-3">
        ix. You agree not to forge headers or otherwise manipulate identifiers
        in order to disguise the origin of any information you transmit;
      </p>
      <p className="mb-3">
        x. You agree not to disable, circumvent, or otherwise interfere with
        security related features of the Service or features that prevent or
        restrict use or copying of any content or which enforce limitations on
        the use of the Service or the content therein;
      </p>
      <p className="mb-3">
        xi. You agree not to post, link to, or otherwise make available on the
        Service any material that contains software viruses or any computer
        code, file or program designed to interrupt, destroy, limit or monitor
        the functionality of any computer software or hardware or any
        telecommunications equipment;
      </p>
      <p className="mb-3">
        xii. You agree not to license, sublicense, sell, resell, transfer,
        assign, distribute or otherwise in any way commercially exploit or make
        available the Service or any Content to any third party;
      </p>
      <p className="mb-3">
      ...
      <p className="mb-3">
        a. You acknowledge that the Service is a general-purpose tool.
        ...
        and/or convert that media.{" "}
        <b>
          {" "}
          The Service may only be used in accordance with law. We do not
          encourage, condone, induce, or allow any use of the Service that may
          be in violation of any law.
        </b>{" "}
        We explicitly prohibit the use of the Service to download any content in
        violation of copyright laws.
      </p>
      <p className="mb-3">
        b. To the extent that we may store any User Submissions whatsoever, we
        do not intend to store any User Submissions for anything longer than a
        transitory period of time to give users chance to download their
        content.
      </p>

      <h2 className="text-[20px] mb-3 font-semibold">8. Fees</h2>
      <p className="mb-3">
        a. You acknowledge that we reserve the right to charge for any or all of
        our services and to change our fees from time to time in our sole
        discretion. If at any time we terminate your rights to use the Service
        ...
        posted on the Service and/or imposed by any sales agent or payment
        processing company, as may be amended from time to time.
      </p>

      <h2 className="text-[20px] mb-3 font-semibold">9. Privacy Policy</h2>
      <p className="mb-3">
        a. We retain a separate Privacy Policy and your assent to these Terms
        also signifies that you have read and understand the Privacy Policy. We
        reserve the right to amend the Privacy Policy at any time by posting
        such amendments to the Service or our website. No other notification may
        be made to you about any amendments. Your continued use of the App
        following such amendments will be deemed your acknowledgement of the
        Privacy Policy and that you have read and understand it.
      </p>

      <p className="mb-3">
        b. You acknowledge that we may collect and use technical data and
        ...
        that is gathered periodically to facilitate the provision of updates to
        the Service.
      </p>
      <p className="mb-3">
        c. You understand, acknowledge and agree that we may access, preserve
        and disclose your information if required to do so by law or in a good
        faith belief that such access, preservation or disclosure is reasonably
        desirable or necessary for us.
      </p>

      <h2 className="text-[20px] mb-3 font-semibold">10. Copyright Claims</h2>

      <p className="mb-3">
        a. We respect the intellectual property rights of others. You may not
        infringe the copyright, trademark, or other proprietary informational
        rights of any party. We may in our sole discretion remove any Content
        (or restrict use of the Service with any Content) we have reason to
        believe violates any of the intellectual property rights of others and
        may terminate your use of the Service if you submit any such Content.
      </p>
      ...
      <ol style={{ listStyleType: "decimal" }}>
        <li className="mb-3 ml-8">
          ...
          any user for whose MATERIAL we receive three good-faith and effective
          complaints within any contiguous six-month period will have his grant
          of use of the Service terminated.
        </li>
      </ol>

      <p className="mb-3">
        c. Although we are not subject to United States law, we voluntarily
        comply with the Digital Millennium Copyright Act. Pursuant to Title 17,
        Section 512(c)(2) of the United States Code, if you believe that any of
        your copyrighted material is being infringed on the Service, we have
        designated an agent to receive notifications of claimed copyright
        infringement. Notifications should be e-mailed to
        contact.fbdownloaderr@gmail.com.
      </p>
      <p className="mb-3">
        d. All notifications not relevant to us or ineffective under the law
        will receive no response or action thereupon. An effective notification
        of claimed infringement must be a written communication to our agent
      ...
      <p className="mb-3">
        e. If your User Submission or a result to your content is removed
      ...
      <p className="mb-3">i. Your physical or electronic signature;</p>
      <p className="mb-3">
      ...
      <p className="mb-3">
        ...
        that you consent to the jurisdiction of the courts in the address you
        provided and the location in which the purported copyright owner is
        located; and
      </p>
      <p className="mb-3">
      ...
      <p className="mb-3">
        ...
        amended Terms to the Service. No other notification may be made to you
        about any amendments. YOU ACKNOWLEDGE THAT YOUR CONTINUED USE OF THE
        SERVICE FOLLOWING SUCH AMENDMENTS WILL CONSTITUTE YOUR ACCEPTANCE OF
      ...
      <p className="mb-3">
        ...
        all damages and third-party claims and expenses, including attorney’s
        fees, arising from your use of the Service and/or from your breach of
        these Terms.
      </p>
      <p className="mb-3">
        b. In the event that you have a dispute with one of more other users or
        any third parties, you hereby release us, our officers, employees,
        agents and successors-in-right from claims, demands and damages (actual
        and consequential) of every kind or nature, known and unknown, suspected
        and unsuspected, disclosed and undisclosed, arising out of or in any way
        related to such disputes and/or the Service.
      </p>
      ...
      <p className="mb-3">
        ...
        services which are independent of us. We assume no responsibility for
        the content, privacy policies, or practices of and make no
        representation or warranty as to the accuracy, completeness or
        authenticity of information contained in any third party websites or
        other services. We have no right or ability to edit the content of any
        third party websites or other services. You acknowledge that we shall
        not be liable for any and all liability arising from your use of any
        third party websites or other services.
      </p>
      <p className="mb-3">
        c. The Service is provided “AS-IS” and without any warranty or
        condition, express, implied, or statutory. We specifically disclaim to
        the fullest extent any implied warranties of merchantability, fitness
        for a particular purpose, non-infringement, information accuracy,
        integration, interoperability or quiet enjoyment. We disclaim any
      ...
      <p className="mb-3">
        ...
        HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES) RESULTING FROM ANY
        ASPECT OF YOUR USE OF THE SERVICE, WHETHER, WITHOUT LIMITATION, SUCH
        DAMAGES ARISE FROM (i) YOUR USE, MISUSE OR INABILITY TO USE THE SERVICE,
        (ii) YOUR RELIANCE ON ANY CONTENT ON THE SERVICE, (iii) THE
        INTERRUPTION, SUSPENSION, MODIFICATION, ALTERATION OR COMPLETE
        DISCONTINUANCE OF THE SERVICE OR (iv) THE TERMINATION OF SERVICE BY US.
      ...
      <ol style={{ listStyleType: "decimal" }}>
        <li className="mb-3 ml-8">
          WE DO NOT WARRANT THAT (i) THE SERVICE WILL MEET YOUR REQUIREMENTS OR
          EXPECTATIONS, (ii) THE SERVICE WILL BE UNINTERRUPTED, TIMELY, SECURE,
          OR ERROR-FREE, (iii) THE RESULTS THAT MAY BE OBTAINED FROM YOUR USE OF
          THE SERVICE WILL BE ACCURATE OR RELIABLE, (iv) THE QUALITY OF ANY
          PRODUCTS, SERVICES, INFORMATION, CONTENT OR OTHER MATERIAL OBTAINED
          THROUGH THE SERVICE WILL MEET YOUR REQUIREMENTS OR EXPECTATIONS, OR
      ...
      <p className="mb-3">
        ...
        YOUR OWN DISCRETION AND RISK. YOU ARE SOLELY RESPONSIBLE FOR ANY DAMAGE
      ...
      <p className="mb-3">
        ...
        WITH THE SERVICE OR ANY OTHER GRIEVANCE SHALL BE THE TERMINATION OF YOUR
        USE OF THE SERVICE. WITHOUT LIMITING THE FOREGOING, IN NO CASE SHALL THE
      ...
      <p className="mb-3">
        ...
        liabilities shall be deemed to apply to our parent companies,
      ...
      <h2 className="text-[20px] mb-3 font-semibold">14. Disputes</h2>

      <p className="mb-3">
        a. To the maximum extent permitted by law, these Terms as well as any
        claim, cause of action, or dispute that may arise between maiyou and us,
        are governed by the laws of the Socialist Republic of Vietnam without
        regard to conflict of law provisions. FOR ANY CLAIM BETWEEN US, YOU
        AGREE TO SUBMIT AND CONSENT TO THE PERSONAL AND EXCLUSIVE JURISDICTION
        IN, AND THE EXCLUSIVE VENUE OF THE COURTS IN the Socialist Republic of
        Vietnam. However, in the event that we are seeking indemnification from
        you hereunder, we may file suit for indemnification (and any other
        claims) in the same court in which the claim against us for which we are
        seeking indemnification is brought. You hereby waive any right to seek
      ...
      <p className="mb-3">
        ...
        <b>
          {" "}
          You hereby agree that as part of the consideration for these terms,
          you are hereby waiving any right you may have to a trial by jury for
          any dispute between the us arising from or relating to these terms or
          the Service. This provision shall be enforceable even in the case that
          any arbitration provisions or any other provisions of this section are
          waived.
        </b>
      </p>

      <h2 className="text-[20px] mb-3 font-semibold">15. General Terms</h2>
      ...
      <p className="mb-3">
        ...
        than English and there is any conflict between the translation and the
